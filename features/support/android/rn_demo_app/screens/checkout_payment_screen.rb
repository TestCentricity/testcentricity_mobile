class CheckoutPaymentScreen < BaseRNDemoAppScreen
  ...
  textfields cardholder_name:      { xpath: '(//android.widget.EditText[@content-desc="Full Name* input field"])[1]' },
             ...
             bill_name:            { xpath: '(//android.widget.EditText[@content-desc="Full Name* input field"])[2]' },
