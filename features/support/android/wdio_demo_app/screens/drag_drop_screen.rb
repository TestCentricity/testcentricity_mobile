class DragDropScreen < BaseWDIODemoAppScreen
  ...
  labels   header_label:      { xpath: '//android.view.ViewGroup[@content-desc="Drag-drop-screen"]/android.view.ViewGroup[1]/android.widget.TextView' },
           retry_message:     { xpath: '//android.view.ViewGroup[@content-desc="Drag-drop-screen"]/android.view.ViewGroup[1]/android.widget.TextView' }
